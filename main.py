...
#Call LLM model , here - mistral.mistral-7b-instruct-v0:2
def get_llm():
    llm = Bedrock(model_id = "mistral.mistral-7b-instruct-v0:2", client = bedrock)
    return llm

# Provide general prompt
prompt_template = """
...
## Pass the prompt to template
PROMPT = PromptTemplate(
    template=prompt_template, input_variables=["context", "question"]
)


# Pass the context & question to LLM to get the response
